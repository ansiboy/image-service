...
export class VideoController {
    ...
    @action()
    async upload(@routeData d: { video: Buffer, name?: string }, @request req: IncomingMessage) {
    ...
    @action()
    async list(@routeData d: { args: DataSourceSelectArguments }, @request req: IncomingMessage) {
